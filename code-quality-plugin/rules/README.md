...
- Evaluates changed code against the ECS rules
...
The `code-quality-ecs:ecs` skill automatically activates when Claude is writing, modifying, reviewing, or designing code, making Claude aware of the ECS rules during development.
...
- **9 core rules** for maintainable ECS game code (coupling/cohesion, system dependencies, event architecture, etc.)
